...
function initMap() {
    var latitude = 25.574718,
		longitude = -80.3709457,
		latitude1 = 25.7777608,
        longitude1 = -80.188326,
        latitude2 = 25.689466,
        longitude2 = -80.313049,
        map_zoom = 11;
    
    var addresses = [[latitude, longitude], [latitude1, longitude1], [latitude2, longitude2]];   

    var map = new google.maps.Map(document.getElementById('map'), {
        zoom: map_zoom,
        center: new google.maps.LatLng(25.722258, -80.278444)
    });

    var image = 'assets/img/icons/map.png';
    for (var i =0; i < addresses.length; i++) {
        new google.maps.Marker({
            position: {lat: addresses[i][0], lng: addresses[i][1]},
            map: map,
            icon: image
        });
    }
